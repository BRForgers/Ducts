package br.com.brforgers.mods.hoppersplus.blocks
...
import br.com.brforgers.mods.hoppersplus.screens.HPScreenHandlerFactory
    ...
    override fun onUse(
        ...
        if (!world.isClient) {
            ...
            if (entity is DuctBlockEntity && screenHandler != null) {
                player.openHandledScreen(HPScreenHandlerFactory(::DuctGuiDescription,pos))
            }
        }
