package br.com.brforgers.mods.hoppersplus.blockentities

import br.com.brforgers.mods.hoppersplus.HoppersPlus
import br.com.brforgers.mods.hoppersplus.blocks.DuctBlock
import br.com.brforgers.mods.hoppersplus.fromTag
import br.com.brforgers.mods.hoppersplus.screens.DuctGuiDescription
import br.com.brforgers.mods.hoppersplus.toTag
...
class DuctBlockEntity(
    ...
    override fun getDisplayName(): Text {
        return customName ?: TranslatableText("screen.hoppersplus.duct")
    }
    ...
    companion object {
        val type = BlockEntityType.Builder.create(Supplier { DuctBlockEntity() }, HoppersPlus.DUCT_BLOCK).build(null)!!
    }
}
